...
namespace Cadenaconexion
{
    public partial class Tienda : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Se han añadido los datos correctamente."); //Mensaje para comprobar si se añadieron datos (están por orden de letra)
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            cmd2.ExecuteNonQuery(); //Mensaje que verifique si se actualizó
